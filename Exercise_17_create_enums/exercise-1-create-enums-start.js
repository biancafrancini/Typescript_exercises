...
(function (LanguageStatus) {
    LanguageStatus["StatusFirst"] = "primary";
    LanguageStatus["StatusSecond"] = "secondary";
})(LanguageStatus || (LanguageStatus = {}));
var countryLanguages = [
    { language: "Spanish", status: LanguageStatus.StatusFirst },
    { language: "English", status: LanguageStatus.StatusSecond },
];
